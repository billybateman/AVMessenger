class mx.controls.Loader extends mx.core.View
{
    ...
    function doScaleContent()
    {
        ...
        var _loc6 = _origWidth - _loc2.left - _loc2.right;
        var _loc8 = _origHeight - _loc2.top - _loc2.bottom;
        var _loc9 = _loc2.left;
        var _loc7 = _loc2.top;
        var _loc5 = _loc6 / contentHolder._width;
        var _loc3 = _loc8 / contentHolder._height;
        var _loc4;
        if (_loc5 > _loc3)
        {
            _loc9 = _loc2.left + Math.floor((_loc6 - contentHolder._width * _loc3) / 2);
            _loc4 = _loc3;
        }
        else
        {
            _loc7 = _loc2.top + Math.floor((_loc8 - contentHolder._height * _loc5) / 2);
            _loc4 = _loc5;
        } // end else if
        _loc4 = _loc4 * 100;
        contentHolder._xscale = contentHolder._yscale = _loc4;
        contentHolder._x = _loc9;
        contentHolder._y = _loc7;
